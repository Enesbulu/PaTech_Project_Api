...
namespace Core.Persistence.Migrations
{
    ...
    [Migration("20240519135425_AddedCorrectionRequest")]
    partial class AddedCorrectionRequest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eeda1f3d-f09a-4a6c-ae1b-cd1a2e32b8a4"),
                            CategoryId = new Guid("62efdf5e-a5a6-47c8-b853-8de7a23308b3"),
                            CommentCount = 10,
                            Content = "C# 9.0 ile ilgili makaleler",
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 470, DateTimeKind.Local).AddTicks(7990),
                            Date = new DateTime(2024, 5, 19, 16, 54, 22, 470, DateTimeKind.Local).AddTicks(7976),
                            IsDeleted = false,
                            Status = 1,
                        ...
                        new
                        {
                            Id = new Guid("cdfdd93c-1648-43c9-9b54-a88112e09259"),
                            CategoryId = new Guid("c33260dd-b051-4a2d-923a-4c16553e4753"),
                            CommentCount = 10,
                            Content = "Java 11 ile ilgili makaleler",
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 470, DateTimeKind.Local).AddTicks(7998),
                            Date = new DateTime(2024, 5, 19, 16, 54, 22, 470, DateTimeKind.Local).AddTicks(7996),
                            IsDeleted = false,
                            Status = 1,
                            Thumbnail = "java.png",
                            Title = "Java 11",
                        ...
                        new
                        {
                            Id = new Guid("7e2b28f1-483a-495d-bc3e-58eab4480e0e"),
                            CategoryId = new Guid("62efdf5e-a5a6-47c8-b853-8de7a23308b3"),
                            CommentCount = 10,
                            Content = "Python 3.9 ile ilgili makaleler",
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 470, DateTimeKind.Local).AddTicks(8003),
                            Date = new DateTime(2024, 5, 19, 16, 54, 22, 470, DateTimeKind.Local).AddTicks(8002),
                            IsDeleted = false,
                            Status = 1,
            ...
            modelBuilder.Entity("Core.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 476, DateTimeKind.Local).AddTicks(3341),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 476, DateTimeKind.Local).AddTicks(3355),
            ...
            modelBuilder.Entity("Core.Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("adac0ead-fc23-4576-9dbc-25feb48e8a10"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 467, DateTimeKind.Local).AddTicks(512),
                            IsDeleted = false,
                            Name = "Admin",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("152e1254-4b22-4d18-b261-9a6ed553ecbb"),
                            AuthenticatorType = 0,
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 469, DateTimeKind.Local).AddTicks(6667),
                            CultureType = 0,
                            Email = "admin@admin.com",
                            FirstName = "Admin",
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 35, 147, 115, 193, 78, 141, 210, 213, 52, 166, 109, 53, 227, 63, 151, 185, 72, 8, 8, 29, 94, 122, 113, 130, 246, 244, 107, 79, 38, 75, 35, 224, 12, 211, 158, 245, 243, 33, 22, 165, 150, 68, 81, 171, 32, 103, 87, 188, 164, 123, 42, 198, 82, 85, 164, 149, 229, 156, 161, 63, 32, 132, 116, 153 },
                            PasswordSalt = new byte[] { 247, 214, 11, 179, 244, 97, 102, 48, 23, 14, 53, 232, 210, 245, 73, 140, 103, 62, 1, 66, 79, 71, 68, 162, 56, 180, 25, 120, 193, 152, 57, 10, 66, 133, 1, 211, 191, 166, 223, 172, 202, 20, 80, 161, 3, 132, 165, 214, 230, 219, 201, 66, 26, 122, 213, 75, 126, 106, 87, 117, 5, 80, 161, 235, 233, 6, 88, 132, 102, 209, 96, 16, 163, 91, 21, 140, 102, 174, 3, 106, 56, 230, 199, 109, 204, 188, 177, 133, 31, 205, 23, 69, 252, 215, 188, 82, 122, 173, 134, 130, 59, 238, 192, 55, 215, 88, 93, 221, 156, 229, 28, 58, 81, 246, 6, 61, 134, 203, 40, 89, 100, 128, 226, 46, 250, 37, 127, 145 },
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4bc7a8d2-fa1b-451a-813d-0d80e64932d4"),
                            CreatedBy = "Admin",
                            CreatedDate = new DateTime(2024, 5, 19, 16, 54, 22, 470, DateTimeKind.Local).AddTicks(2418),
                            IsDeleted = false,
                            OperationClaimId = new Guid("adac0ead-fc23-4576-9dbc-25feb48e8a10"),
                            Status = 1,
                            UserId = new Guid("152e1254-4b22-4d18-b261-9a6ed553ecbb")
                        });
                });
